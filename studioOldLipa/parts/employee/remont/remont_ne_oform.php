<div class="remont_ne_oform_usluga-block">
    ...
    <?php
        ...
        $query = "SELECT * FROM zakaz_remont WHERE employee_login IS NULL ";
...
<script>
    $('.ne_oform_content_tr').on('click', function(){
        $("content").load("parts/employee/remont/remont_employee_order_page.php", {'zakaz_id' : $(this).attr( 'attr' ) } );
    });
